...
# =================================================
# 13. 2-WAVE FIGURE: SMOKING PROBABILITY
# =================================================

plot_df = reg.copy()
prob = plot_df.groupby("pattern_primary")["smoker_w7"].mean()

order = ["low_low", "emergent_w7_only", "transient_w6_only", "persistent"]
prob = prob.reindex(order)
...
plt.tight_layout()
plt.savefig("figure_primary_smoking_probability.png", dpi=300)
plt.show()
