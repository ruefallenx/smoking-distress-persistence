...
usecols_w6 = [
    ...
    "R06_AC1003",        # smoking
    "R06_AN0105",        # tried to quit in past 12 months
...
print("\nquit_attempt_w6 distribution:")
print(df["quit_attempt_w6"].value_counts(dropna=False).sort_index())

# =================================================
# CLEAN QUIT ATTEMPT
# =================================================
df = df[pd.to_numeric(df["quit_attempt_w6"], errors="coerce").notna()]
df = df[df["quit_attempt_w6"] >= 0].copy()

print("\nShape after cleaning quit_attempt_w6:", df.shape)
...
# =================================================
# RESTRICT TO QUIT ATTEMPT SUBGROUP
# Assuming 1 = yes based on PATH-style coding
# =================================================
df = df[df["quit_attempt_w6"] == 1].copy()

print("\nShape after restricting to quit_attempt_w6 == 1:", df.shape)
...
print("\nPattern counts in quit-attempt subgroup:")
...
# =================================================
# MODEL 2: demographic-adjusted with age category
# =================================================
m2 = smf.logit(
...
or1 = extract_or_table(m1, "quit_attempt_baseline")
or2 = extract_or_table(m2, "quit_attempt_adjusted_agecat")

print("\n=== QUIT-ATTEMPT BASELINE MODEL ===")
print(or1)

print("\n=== QUIT-ATTEMPT DEMOGRAPHIC-ADJUSTED MODEL (AGECAT) ===")
print(or2)
...
print("\n=== QUIT-ATTEMPT PATTERN COMPARISON ===")
print(comparison)

comparison.to_csv("comparison_quit_attempt_agecat_models.csv")
or2.to_csv("or_quit_attempt_adjusted_agecat.csv")

print("\nSaved:")
print("- comparison_quit_attempt_agecat_models.csv")
print("- or_quit_attempt_adjusted_agecat.csv")